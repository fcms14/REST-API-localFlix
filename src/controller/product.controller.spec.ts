...
import { createProduct, deleteProduct, updateProduct, selectProduct } from './product.controller';
...
describe('selectProduct', () => {
    it('should not be able to select a product with empty productId', async () => {
        ...
        expect((await selectProduct(request, createResponse())).statusCode).toBe(406);
    });
...
describe('createProduct', () => {
    it('should not be able to create a product with empty usersId', async () => {
        expect((await createProduct({body: {usersId: ''}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a user with usersId as a string', async () => {
        expect((await createProduct({body: {usersId: 'a'}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with empty type', async () => {
        expect((await createProduct({body: {usersId: '1', type: ''}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with type not allowed', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'cars'}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with empty method', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: ''}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with method not allowed', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'change'}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with empty inventory', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'renting', inventory: ''}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with inventory as a string', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'renting', inventory: 'a'}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with inventory less than zero', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'renting', inventory: -1}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with empty price', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'renting', inventory: 0, price: ''}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with price as a string', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'renting', inventory: 0, price: 'a'}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with price less than or equal to zero', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'renting', inventory: 0, price: 0}} as Request, createResponse())).statusCode).toBe(406);
    });

    it('should not be able to create a product with empty title', async () => {
        expect((await createProduct({body: {usersId: '1', type: 'books', method: 'renting', inventory: 0, price: 1, title: ''}} as Request, createResponse())).statusCode).toBe(406);
    });
});
...
describe('updateProduct', () => {
    it('should not be able to update a product with empty usersId', async () => {
        ...
        expect((await updateProduct(request, createResponse())).statusCode).toBe(406);
    });
...
describe('deleteProduct', () => {
    it('should not be able to delete a product with empty productId', async () => {
        ...
        expect((await deleteProduct(request, createResponse())).statusCode).toBe(406);
    });
